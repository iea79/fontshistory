...
function frondendie_scripts()
{
	...
	if (is_front_page()) {
		wp_enqueue_script('gsap', 'https://cdn.jsdelivr.net/npm/gsap@3.12.5/dist/gsap.min.js', '', _S_VERSION, true);
		wp_enqueue_script('gsap-scroll-trigger', 'https://cdn.jsdelivr.net/npm/gsap@3.12.5/dist/ScrollTrigger.min.js', '', _S_VERSION, true);
		wp_enqueue_script('gsap-scroll-to', 'https://cdn.jsdelivr.net/npm/gsap@3.12.5/dist/ScrollToPlugin.min.js', '', _S_VERSION, true);
